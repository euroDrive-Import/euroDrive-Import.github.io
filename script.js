const translations = {
    es: {
        ...
        footerRights: "© 2026 EuroDrive Import. Exclusividad y Profesionalidad.",
    ...
    tzm: {
        ...
        footerLegal: "Asḍuf",
        legalAviso: "Awal asḍuf",
        legalPrivacidad: "Tarrayt n tuffra",
        legalTerminos: "Tiwtilin n useqdec",
        footerRights: "© 2026 EuroDrive Import. Tifrat d tawwuri.",
        heroEyebrow: "Tirmit Tifazt",
        heroH1: "Takerrust n targit-nnk seg <span id='dynamicCountry' class='flag-text-germany'>Lalman</span>,<br>ɣer tewwurt-nnk.",
        heroP: "Nettedwel s kulci: asenqed lqayen, tiɣin taminant, asuk asarug d ujerred aɣelnaw. Faṛes tifrat bla aɣilif.",
        btnComenzar: "Bdu Asekyel",
        btnDescubrir: "Snirem Akatar",
        ...
        feat2Desc: "Tigrawin timeqqranin g tikerrusin n tgari d tifaznin mnid n ugadez aɣelnaw.",
        ...
        proc4Desc: "Asikel ɣer Spanya, afru n ibzaz d ujerred aneggaru.",
        formH1: "Af-d Takerrust-nnk",
        formP: "Ečč isallen akken ad d-yemeslay yiwen seg imazzagen-nneɣ yid-k.",
        formStep1: "1. Isallen n Unermis",
        labelNombre: 'Isem d Mmis <span style="color:var(--primary)">*</span>',
        labelTel: 'Uṭṭun n Tiliɣri <span style="color:var(--primary)">*</span>',
        labelEmail: 'Imayl <span style="color:var(--primary)">*</span>',
        btnNext: "Zdi Abrid →",
        formStep2: "2. Isallen n Tkerrust",
        labelMarca: 'Tamacahut <span style="color:var(--primary)">*</span>',
        labelModelo: 'Amudil <span style="color:var(--primary)">*</span>',
        labelAno: 'Aseggas <span style="color:var(--primary)">*</span>',
        labelKms: 'Ikilumitren <span style="color:var(--primary)">*</span>',
        labelCombustible: 'Azzur <span style="color:var(--primary)">*</span>',
        labelTrans: 'Asedri <span style="color:var(--primary)">*</span>',
        labelPresupuesto: 'Afniq <span style="color:var(--primary)">*</span>',
        labelExtras: 'Tiɣwawin <span style="color:var(--primary)">*</span>',
        optSelect: "Fren yiwen",
        optDiesel: "Mazut",
        optGas: "Lisans",
        optHyb: "Ablut",
        optElec: "Atris",
        ...
        phAno: "Md: 2015",
        phKms: "Md: 180.000KM",
        phPresupuesto: "Md: 15.000€",
        phExtras: "Md: Tiɣwawin..."
    }
};
...
document.addEventListener('DOMContentLoaded', () => {
    ...
    if (!savedTheme) {
        ...
        savedTheme = systemPrefersDark ? 'dark' : 'dark'; 
    }
